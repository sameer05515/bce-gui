...
angular
    ...
    .controller("fileSearchController", [
        ...
        function ($scope, $log, $http) {
			...
			$scope.multiRequests=[
			{
					myurl : "http://127.0.0.1:8888/FileService/diff12April.json",
					methodtype : "GET",
					parameters : {},
					mydata : {}
				},
				{
					myurl : "http://127.0.0.1:8888/ClickCounter123/",
					methodtype : "GET",
					parameters : {},
					mydata : {}
				},
				{
					myurl : "http://127.0.0.1:8888/ClickCounter/",
					methodtype : "GET",
					parameters : {},
					mydata : {}
				}
			...
			$scope.loadMultiURLData= function (){
				...
				var urrrlll = "http://127.0.0.1:8888/FileService/diff12April.json";
                $http({
                        method: "GET",
                        url: urrrlll,
