				...
				[
						...
						function($scope, $http, $log) {
							...
							$scope.loadResult =function() {
								...
								var urrrlll="http://127.0.0.1:8090/FileService/fileService.jsp?fileName="+$scope.foldername+"";
								$http(
										{
											method : 'POST',
											url :urrrlll
...
angular
    ...
    .controller("fileSearchController", [
        ...
        function ($scope, $log, $http) {
			...
			$scope.multiRequests=[
			{
					myurl : "http://127.0.0.1:8090/FileService/diff12April.json",
					methodtype : "GET",
					parameters : {},
					mydata : {}
				},
			...
			$scope.loadMultiURLData= function (){
				...
				var urrrlll = "http://127.0.0.1:8090/FileService/diff12April.json";
                $http({
                        method: "GET",
                        url: urrrlll,
                    ...
                    .success(function (data,status) {
						...
						alert('success status code'+status+' myfolder == '+urrrlll);
                        ...
                        var obj = {};
                        obj.message =
                            "Successfully got " + data.length + " result for " + urrrlll;
                        obj.type = "success";
                    ...
                    .error(function (data,status) {
                        var obj = {};
                        obj.message = "Error while getting result for " + urrrlll;
                        obj.type = "fail";
						
						alert('fail status code'+status+' myfolder == '+urrrlll);
