    ...
    .controller(
        'fileSearchWithPopupController', [
            ...
            function ($scope, $http) {
                ...
                $scope.mytestuurl = "http://127.0.0.1:8090/sharedServicesProvider/pdfContentViewer.jsp?fileName=D:/ebooks/GAUNTLT/curl-7.43.0/curl-7.43.0/docs/libcurl/opts/CURLOPT_DNS_USE_GLOBAL_CACHE.pdf";
