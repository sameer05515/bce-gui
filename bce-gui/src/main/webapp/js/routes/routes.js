...
app.config([
  ...
  function ($routeProvider) {
    $routeProvider
      ...
      .when("/", {
        templateUrl:
          "partials/home.html" /*,controller:"homeCtrl" , controller: "PshortDescriptionCtrl" */,
      })
      // PshortDescriptions
      .when("/about", {
        templateUrl:
          "partials/about.html" /* , controller: "PshortDescriptionCtrl" */,
      })
      .when("/faq", {
        templateUrl:
          "partials/faq.html" /* , controller: "PshortDescriptionCtrl" */,
      })
      .when("/pricing", {
        templateUrl:
          "partials/pricing.html" /* , controller: "PshortDescriptionCtrl" */,
      })
      .when("/services", {
        templateUrl:
          "partials/services.html" /* , controller: "PshortDescriptionCtrl" */,
      })
      .when("/contact", {
        templateUrl:
          "partials/contact.html" /* , controller: "PshortDescriptionCtrl" */,
      })
      .when("/my-resume", {
      ...
      .when("/questions-single-view", {
        templateUrl:
          "partials/interview-mgmt/categories/questionsSingleView.html",
      ...
      .when("/categories/:catID/questions", {
        templateUrl:
          "partials/interview-mgmt/questions/showAllQuestions-list.html",
      ...
      .otherwise("/404", {
        templateUrl:
          "../../partials/404.html" /* , controller: "PshortDescriptionCtrl" */,
      });
  },
]);
